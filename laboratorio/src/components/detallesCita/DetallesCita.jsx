                ...
                <form className="" >
                    <div className="form-row">
                        <div className="form-group col-md-12">
                            ...
                            <input type="text" className="form-control" id="paciente" value={this.state.paciente} placeholder="Nombre completo" />
                        </div>
                    </div>
                    <div className="form-row">
                    ...
                    <div className="form-row">
                        <div className="containerForm form-group col-md-12">
                            <button type="button" onClick={this.listaCitas} className="btn accionGuardar" >
